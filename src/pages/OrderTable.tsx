...
const OrderTable = () => {
  ...
  const columns = [
    ...
    columnHelper.accessor("productDetail.name", {
      ...
      header: () => (
        <div className="flex items-center gap-1 capitalize">product Name</div>
      ),
    }),
    columnHelper.accessor("userDetails.userEmail", {
      ...
      header: () => (
        <div className="flex items-center gap-1 capitalize">user email</div>
      ),
    }),
    ...
    columnHelper.accessor("orderPlaceOn", {
      header: () => (
        <div className="flex items-center gap-1 capitalize">Order Date</div>
      ),
      cell: (info) => (
        <div className="text-gray-800">{formatDate(info.getValue())}</div>
      ),
    }),
    columnHelper.accessor("totalPrice", {
      header: () => (
        <div className="flex items-center gap-1 capitalize">Price</div>
      ),
      cell: (info) => (
        <div className="text-sm font-medium text-gray-900">
          {formatPrice(
            info.getValue(),
            info.row.original.productDetail.currency
          )}
        </div>
      ),
    }),
    ...
    columnHelper.accessor("_id", {
      header: () => (
        <div className="flex items-center gap-1 capitalize">Actions</div>
      ),
      cell: (info) => (
  ...
  if (isError) {
    ...
    const errorMessage =
      ...
      "Something went wrong!.Error loading user details. Please try again later.Or refresh the page";
        ...
        <div className="container p-4 mx-auto">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4">
            ...
            <div className="p-6 border shadow-sm bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl border-amber-200">
              ...
              <div className="mt-2">
                <p className="text-3xl font-bold text-amber-700">
                  {data.productOrderStatusCount.processed}
                </p>
            ...
            <div className="p-6 border border-indigo-200 shadow-sm bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl">
              ...
              <div className="mt-2">
                <p className="text-3xl font-bold text-indigo-700">
                  {data.productOrderStatusCount.shipped}
                </p>
            ...
            <div className="p-6 border shadow-sm bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl border-emerald-200">
              ...
              <div className="mt-2">
                <p className="text-3xl font-bold text-emerald-700">
                  {data.productOrderStatusCount.delivered}
                </p>
            ...
            <div className="p-6 border border-purple-200 shadow-sm bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl md:col-span-2">
              ...
              <div className="mt-2">
                <ul className="space-y-2">
                  {data.top5MostBought.map(
                    (item: OrderBoughtItem, index: number) => (
                      <li
                        key={index}
                        className="flex items-center justify-between pb-2 border-b border-purple-200"
                      >
                        <span className="text-gray-700">{item.name}</span>
                        <span className="font-medium text-purple-700">
                          {item.value.quantity} units
                        </span>
                      </li>
                    )
                  )}
            ...
            <div className="p-6 border border-red-200 shadow-sm bg-gradient-to-br from-red-50 to-red-100 rounded-xl md:col-span-2">
              ...
              <div className="mt-2">
                <ul className="space-y-2">
                  {data.top5MostExpensiveOrders.map(
                    (item: OrderTableProps, index: number) => (
                      <li
                        key={index}
                        className="flex items-center justify-between pb-2 border-b border-red-200"
                      >
                        <span className="text-gray-700">
                          {item.productDetail.name}
                        </span>
                        <span className="font-medium text-red-700">
                          {formatPrice(item.productDetail.price, "USD")}
                        </span>
                      </li>
                    )
                  )}
            ...
            <div className="p-6 border border-teal-200 shadow-sm bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl md:col-span-2">
              ...
              <div className="mt-2">
                <ul className="space-y-2">
                  {data.top5LeastExpensiveOrders.map(
                    (item: OrderTableProps, index: number) => (
                      <li
                        key={index}
                        className="flex items-center justify-between pb-2 border-b border-teal-200"
                      >
                        <span className="text-gray-700">
                          {item.productDetail.name}
                        </span>
