...
const SingleProductPage = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: async () => {
      toast.success(
        "Proudct is deleted successfully.Redirecting to product table page",
        { position: "top-right" }
      );
          ...
          <div className="grid grid-cols-1 gap-8 p-4 rounded-lg shadow-lg md:grid-cols-2 sm:p-6 bg-card/50">
            ...
            <div className="flex flex-col justify-center p-2 ">
              ...
              <div className="flex flex-col items-center justify-center gap-4 mb-4 md:flex-row md:justify-start">
                ...
                <span className="ml-4 text-lg text-orange-400 ">
              ...
              <div className="flex gap-4 mt-4">
                <button
                  className="flex items-center justify-center gap-1 px-2 text-white bg-sky-500 py-1.5 rounded-lg hover:bg-sky-600"
                ...
                <button
                  className="flex items-center justify-center gap-1 px-2 text-white bg-red-500 py-1.5 rounded-lg hover:bg-red-600"
