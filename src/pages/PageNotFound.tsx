...
const PageNotFound = () => {
  return (
    ...
    <div className="flex flex-col items-center justify-center px-4 py-8 bg-white border border-gray-200 rounded-lg shadow-2xl md:px-8 lg:px-24">
        ...
        <Link to={'/dashboard'} className="flex items-center px-4 py-2 mt-6 space-x-2 text-gray-100 transition duration-150 bg-blue-600 rounded hover:bg-blue-700" title="Return Home">
            <MoveLeftIcon/>
