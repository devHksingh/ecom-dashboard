...
const SingleProductLoder = () => {
  return (
    
    <div className="flex flex-col gap-5 p-2 bg-white shadow-lg select-none sm:p-4 sm:h-64 rounded-2xl sm:flex-row ">
...
export default SingleProductLoder